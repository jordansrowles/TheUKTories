function parseCookie(e) {
        ...
        start: function (e) {
            ...
            for (var i = this.find(e), r = 0, a = i.length; r < a; r++)
                for (var s = i[r], c = s.getAttribute("data-module").split(" "), l = 0, u = c.length; l < u; l++) {
                    ...
                    "function" != typeof f.Modules[d] || p || f.Modules[d].prototype.init && (new f.Modules[d](s).init(), s.setAttribute("data-" + c[l] + "-module-started", !0))
                }
        }
    }, e.GOVUK = f
    ...
    function (e) {
        ...
        function o() {
            ...
            var n = [];
            if (t)
                for (var o = t.split(","), i = 0; i < o.length; i++) n.push(o[i].trim());
            return n
        }
        var i = e.GOVUK || {},
            r = /[^\s=/?&]+(?:@|%40)[^\s=/?&]+/g,
    ...
    function () {
        ...
        function n() {
            return "collections" === e(v) && "taxon" === e(h) && "grid" === e(g)
        }

        function o() {
            return "collections" === e(v) && "taxon" === e(h) && "accordion" === e(g)
        }

        function i() {
            return "collections" === e(v) && "taxon" === e(h) && "leaf" === e(g)
        }

        function r() {
            return "collections" === e(v) && "browse level 2" === e(g)
        }

        function a() {
            return "collections" === e(v) && "cost of living hub" === e(g)
        }

        function s() {
            return "collections" === e(v) && ("browse level 0" === e(g) || "browse level 1" === e(g)) && "mainstream_browse_page" === e(h)
        }

        function c() {
            return "collections" === e(v) && "mainstream_browse_page" === e(h)
        }

        function l() {
            return "collections" === e(v) && "topic" === e(h)
        }

        function u() {
            return "whitehall" === e(v) && "placeholder_policy_area" === e(h)
        }

        function d() {
            return "government-frontend" === e(v) && "document_collection" === e(h)
        }

        function p() {
            return "finder-frontend" === e(v) && "finder" === e(h)
        }

        function f() {
            return "whitehall" === e(v) && "finder" === e(h)
        }
        ...
        t.getNumberOfSections = function () {
            switch (!0) {
                ...
                case c():
                    return m(document.querySelectorAll("#subsection ul")) || document.querySelectorAll("#section ul").length || document.querySelectorAll("#root ul").length;
                case l():
            ...
            switch (!0) {
                ...
                case c():
                    return m(document.querySelectorAll("#subsection ul a")) || document.querySelectorAll("#section ul a").length || document.querySelectorAll("#root ul a").length;
                case l():
        ...
        var v = 'meta[name="govuk:rendering-application"]',
            h = 'meta[name="govuk:format"]',
        ...
        var h = "Site search results",
            ...
            n = function () {
                ...
                this.init = function (e) {
                    for (var t = GOVUK.analytics.stripPII(e.getAttribute("data-search-query")).substring(0, 100).toLowerCase(), n = e.querySelectorAll("[data-ecommerce-row]"), o = parseInt(e.getAttribute("data-ecommerce-start-index"), 10), i = e.getAttribute("data-list-title") || h, r = e.getAttribute("data-ecommerce-variant") || undefined, a = e.getAttribute("data-track-click-label") || g, s = 0; s < n.length; s++) {
                        var c = n[s],
                            ...
                            f = p ? parseInt(p, 10) - 1 : s;
                        m(u, d, f + o, t, i, l, r), v(c, u, d, f + o, t, i, l, r, a)
                    }
                }
            };
...
window.GOVUK.analyticsInit = analyticsInit, window.GOVUK = window.GOVUK || {}, window.GOVUK.Modules = window.GOVUK.Modules || {},
    function (e) {
        function o(e) {
        ...
        o.prototype.init = function () {
            ...
            for (var e = [], t = ["h1", "h2", "h3", "h4", "h5", "h6"], n = this.config.trackHeadings, o = 0; o < this.config.allowHeadingsInside.length; o++)
                for (var i = document.querySelectorAll(this.config.allowHeadingsInside[o]), r = 0; r < i.length; r++)
                    for (var a = i[r].querySelectorAll(t), s = 0; s < a.length; s++) n ? n.includes(a[s].textContent.trim()) && e.push(a[s]) : e.push(a[s]);
            return e
    ...
    function (e) {
        ...
        t.prototype.init = function () {
            ...
            var t = window.GOVUK.cookie("cookies_preferences_set"),
                n = window.GOVUK.getConsentCookie();
            "true" !== t ? this.decorate(this.$module, "cookie_consent=not-engaged", this.attribute) : n && !0 === n.usage ? this.handleCookiesAccepted() : this.decorate(this.$module, "cookie_consent=reject", this.attribute),
                this.$module.removeEventListener(this.eventType, this.handleEvent), "submit" === this.eventType ? this.$module.submit() : this.$module.click()
    ...
    function (e) {
        ...
        t.prototype.init = function () {
            ...
            if (e.hasAttribute("data-track-category") || e.hasAttribute("data-track-action") || (t = e.getAttribute("href"), e = e.closest("[data-track-category][data-track-action]")), e) {
                ...
                if (r && (n.label = r), a && (n.value = a), s && c && (n["dimension" + c] = s), l)
            ...
            function () {
                "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
                    value: function S(t) {
                        ...
                        for (var y, w = f.call(arguments, 1), b = function () {
                            if (this instanceof y) {
                                var e = g.apply(this, m.call(w, f.call(arguments)));
                                return o(e) === e ? e : this
                            }
                            return g.apply(t, m.call(w, f.call(arguments)))
                        }, k = h(0, g.length - w.length), E = [], O = 0; O < k; O++) v.call(E, "$" + O);
    ...
    function (e, t) {
        ...
        return function () {
            ...
            function () {
                ...
                }() || (s = Object.defineProperty, c = Object.prototype.hasOwnProperty("__defineGetter__"), l = "Getters & setters cannot be defined on this javascript engine",
                    u = "A property cannot both have accessors and be writable or have a value", Object.defineProperty = function d(e, t, n) {
                        if (s && (e === window || e === document || e === Element.prototype || e instanceof Element)) return s(e, t, n);
                        if (null === e || !(e instanceof Object || "object" == typeof e)) throw new TypeError("Object.defineProperty called on non-object");
                        if (!(n instanceof Object)) throw new TypeError("Property description must be an object");
                        var o = String(t),
                        ...
                        window.Event = Window.prototype.Event = function r(e, t) {
                            ...
                            l._events || (l._events = {}), l._events[n] || (l._events[n] = function (e) {
                                ...
                                for (e.preventDefault = function a() {
                                    ...
                                    e.cancelBubble = !0, e.cancelImmediate = !0
                                }, e.currentTarget = l, e.relatedTarget = e.fromElement || null, e.target = e.target || e.srcElement || l, e.timeStamp = (new Date).getTime(), e.clientX && (
                                    e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop); ++i < r && !e.cancelImmediate;) i in o && -1 !== u(n, t = o[i]) && "function" == typeof t && t.call(l, e)
                            }, l._events[n].list = [], l.attachEvent && l.attachEvent("on" + n, l._events[n])), l._events[n].list.push(o)
                        }, window.removeEventListener = Window.prototype.removeEventListener = Document.prototype.removeEventListener = Element.prototype.removeEventListener = function s(e, t) {
                            var n, o = this,
                                i = e,
        ...
        var e = function (e, t) {
            ...
            u = {
                ...
                displaySurvey: function (e) {
                    ...
                    if ("email" === e.surveyType) u.displayEmailSurvey(e, t);
                    else {
